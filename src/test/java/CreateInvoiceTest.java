...
public class CreateInvoiceTest {
    ...
    public void test_vietnamese_invoice_creation_success() {
        ...
        assertEquals(success, presenter.getResponseModel().getMessage());
    }
    ...
    public void test_null_customer_type_error() {
        ...
        assertEquals("Customer type cannot be empty", presenter.getResponseModel().getMessage());
    }
    ...
    public void test_null_nationality_error() {
        ...
        assertEquals("Nationality cannot be empty", presenter.getResponseModel().getMessage());
    }
