...
//import org.example.adapter.presenter.NotificationPresenter;
//import org.example.domain.entities.VietnameseInvoice;
//import org.example.domain.entities.models.RequestModel;
//import org.example.domain.interactors.CreateInvoiceUseCase;
...
//    
////    @Test
////    public void test_open_create_invoice_screen() {
////        CreateScreenPresenter createScreenPresenter = new CreateScreenPresenter();
////        OpenCreateScreenUseCase useCase = new OpenCreateScreenUseCase(
////                createScreenPresenter
////        );
////        
////        useCase.execute();
////        assertEquals(createScreenPresenter.isOpen(), true);
////    }
//    
...
//        CreateInvoiceUseCase useCase= new CreateInvoiceUseCase(presenter, new VietnameseRepository(), new ForeignRepository());
//        useCase.createInvoice(req);
//        assertEquals(presenter.getNotifyResponse().getMessage(), "Invoice created failed");
//    }
//
